...
public class exprParser extends Parser {
	...
	public static final int
		T__0=1, Identifier=2, Interger=3, WhiteSpace=4;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, "Identifier", "Interger", "WhiteSpace"
		};
	}
	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (_la==Identifier || _la==Interger) {
				{
				{
				setState(8);
				stat();
	...
	public static class ExpressionContext extends ParserRuleContext {
		public TerminalNode Interger() { return getToken(exprParser.Interger, 0); }
		public TerminalNode Identifier() { return getToken(exprParser.Identifier, 0); }
	...
	public final ExpressionContext expression() throws RecognitionException {
		...
		try {
			...
			setState(24);
			_la = _input.LA(1);
			if ( !(_la==Identifier || _la==Interger) ) {
